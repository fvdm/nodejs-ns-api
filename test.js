...
dotest.add( 'Module', async test => {
  test()
    ...
    .isAsyncFunction( 'fail', '.getAllStations', ns?.getAllStations )
    .isAsyncFunction( 'fail', '.getArrivals', ns?.getArrivals )
    .isAsyncFunction( 'fail', '.getCalamities', ns?.getCalamities )
    .isAsyncFunction( 'fail', '.getDepartures', ns?.getDepartures )
    .isAsyncFunction( 'fail', '.getDisruption', ns?.getDisruption )
    .isAsyncFunction( 'fail', '.getDisruptions', ns?.getDisruptions )
    .isAsyncFunction( 'fail', '.getStationDisruption', ns?.getStationDisruption )
    .isAsyncFunction( 'fail', '.getTrip', ns?.getTrip )
    .isAsyncFunction( 'fail', '.getTrips', ns?.getTrips )
    .isAsyncFunction( 'fail', '.getPrice', ns?.getPrice )
    .isAsyncFunction( 'fail', '.getJourney', ns?.getJourney )
    .isAsyncFunction( 'fail', '.placesList', ns?.placesList )
    .isAsyncFunction( 'fail', '.placesGet', ns?.placesGet )
    .isAsyncFunction( 'fail', '.placesOvfiets', ns?.placesOvfiets )
    .done()
  ;
} );
